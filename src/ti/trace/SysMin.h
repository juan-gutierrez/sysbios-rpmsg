...
#define ti_trace_SysMin___VERS 150
...
/* LineBuffer */
typedef xdc_Char __T1_ti_trace_SysMin_LineBuffer__outbuf;
typedef xdc_Char __ARRAY1_ti_trace_SysMin_LineBuffer__outbuf[256];
typedef __ARRAY1_ti_trace_SysMin_LineBuffer__outbuf __TA_ti_trace_SysMin_LineBuffer__outbuf;
struct ti_trace_SysMin_LineBuffer {
    xdc_UInt outidx;
    __TA_ti_trace_SysMin_LineBuffer__outbuf outbuf;
};
...
xdc__CODESECT(ti_trace_SysMin_Module_startup__R, "ti_trace_SysMin_Module_startup")
__extern xdc_Int ti_trace_SysMin_Module_startup__R( xdc_Int state );

/* Module__startupDone__S */
xdc__CODESECT(ti_trace_SysMin_Module__startupDone__S, "ti_trace_SysMin_Module__startupDone")
...
__extern xdc_Void ti_trace_SysMin_abort__E( xdc_String str );
xdc__CODESECT(ti_trace_SysMin_abort__F, "ti_trace_SysMin_abort")
__extern xdc_Void ti_trace_SysMin_abort__F( xdc_String str );
__extern xdc_Void ti_trace_SysMin_abort__R( xdc_String str );
...
xdc__CODESECT(ti_trace_SysMin_exit__F, "ti_trace_SysMin_exit")
__extern xdc_Void ti_trace_SysMin_exit__F( xdc_Int stat );
__extern xdc_Void ti_trace_SysMin_exit__R( xdc_Int stat );
...
xdc__CODESECT(ti_trace_SysMin_flush__F, "ti_trace_SysMin_flush")
__extern xdc_Void ti_trace_SysMin_flush__F( void );
__extern xdc_Void ti_trace_SysMin_flush__R( void );
...
xdc__CODESECT(ti_trace_SysMin_putch__F, "ti_trace_SysMin_putch")
__extern xdc_Void ti_trace_SysMin_putch__F( xdc_Char ch );
__extern xdc_Void ti_trace_SysMin_putch__R( xdc_Char ch );
...
xdc__CODESECT(ti_trace_SysMin_ready__F, "ti_trace_SysMin_ready")
__extern xdc_Bool ti_trace_SysMin_ready__F( void );
__extern xdc_Bool ti_trace_SysMin_ready__R( void );
...
{
    return ti_trace_SysMin_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_trace_SysMin_Module_getMask( void ) 
{
    return ti_trace_SysMin_Module__diagsMask__C != NULL ? *ti_trace_SysMin_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_trace_SysMin_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_trace_SysMin_Module__diagsMask__C != NULL) *ti_trace_SysMin_Module__diagsMask__C = mask;
}
